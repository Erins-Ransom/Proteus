...
#include "ARF/include/ARF.h"
#include "ARF/include/Statistics.h"
#include "ARF/include/Database.h"
#include "ARF/include/Query.h"
#include "ARF/include/Util.h"
...
int main() {
	...
	std::cout << "Correct: No key exists within range ["
		  << left_key << ", " << right_key << ") " << "according to basic SuRF" << std::endl;
    std::cout << "Memory usage is  " << surf->getMemoryUsage() << std::endl;
